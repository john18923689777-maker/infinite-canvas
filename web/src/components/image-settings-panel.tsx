...
export function ImageSettingsPanel({ config, onConfigChange, theme, showTitle = true, className = "w-[320px] space-y-4 rounded-2xl px-1 py-0.5", maxCount = 15, quickCount = 10 }: ImageSettingsPanelProps) {
    ...
    const imageModel = modelOptionName(config.model || config.imageModel || "").toLowerCase();
    const supportsTransparentBackground = imageModel !== "gpt-image-2";
    const transparentBackground = supportsTransparentBackground && config.background === "transparent";
